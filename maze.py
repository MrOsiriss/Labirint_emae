...
display.set_caption("Лабиринто")
background = transform.scale(image.load("phonk.jpg"), (700, 500))
...
w4 = Wall(255, 255, 255, 350, 20, 10, 380)
w5 = Wall(255, 255, 255, 450, 110, 10, 380)
w6 = Wall(255, 255, 255, 250, 125, 10, 300)
...
win = font.render('YOU SAVED!', True, (255, 215, 0))
lose = font.render('TRY AGAIN...', True, (180, 0, 0))
